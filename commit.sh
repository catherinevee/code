...
AZUREPAT=$AZURE_CLIENT_SECRET
AZUSERNAME= $AZURE_CLIENT_ID
...
git pull https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/code/code.git
...
git push --force https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/code/code.git
